# Personal Project for UBC CPSC210
This is originally a personal class project for CPSC210 Software Construction.
GroupScheduler implements an algorithm to find mutual vacancies for multiple users to schedule a meeting.
Currently runs locally with login features and auto-update for new group schedules.
