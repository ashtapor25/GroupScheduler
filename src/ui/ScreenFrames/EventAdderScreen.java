...
public class EventAdderScreen extends JFrame {

    private GroupScheduler gs;
    private JSpinner startDateSpinner;
    private JSpinner endDateSpinner;

    public Schedule getToAdd() {
        return toAdd;
    }
    ...
    private Schedule toAdd;

    public EventAdderScreen(GroupScheduler gs) {
        ...
        submitButton.addActionListener(e -> {
            ...
            toAdd = new Schedule(userText.getText(), timeframe);
            toAdd.setDescription(descText.getText());

            gs.submitEvent(toAdd);});
